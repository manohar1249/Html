...
var profile = createimg('manohar.jpg')
var dname = create('div', "name");

var h = create('h2')
h.innerHTML = "Manohar Chunchu"

var cnt = create('div', 'contact');
var hr = create('hr');
var details = create('div', "details");
var pcntct = create('p');
pcntct.innerHTML = "Hyderabad | +91 9553622139 | manoharchunchu1249@gmail.com"
...
var h41 = create('h4');
h41.innerHTML = `Oracle weblogic Support Engineer`;
...
var h42 = create('h4');
h42.innerHTML = `Systems Engineer, Hcl Technoligies`;
...
var h43 = create('h4');
h43.innerHTML = `Working as Oracle WebLogic Support Engineer`;
...
li5[0].innerHTML = `<strong>Bachelor of Technology</strong> in the field of Informatio Technoligy in year 2019 with 83.2% from CVR College Of Engineering, Hyderabad.`
