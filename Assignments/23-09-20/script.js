...
let container = create('div','container','cont');
let page = create('div','pagination','page');
let prev = createButton('input','submit','prev','Previous');
let id1 = createButton('input','submit','id1',1);
let id2 = createButton('input','submit','id2',2);
let id3 = createButton('input','submit','id3',3);
let id4 = createButton('input','submit','id4',4);
let id5 = createButton('input','submit','id5',5);
let id6 = createButton('input','submit','id6',6);
let next = createButton('input','submit','nxt','Next');

page.append(prev,id1,id2,id3,id4,id5,id6,next);

let area = create('div','tarea','area1');
let tarea = createArea('textarea','tarea','area',7,10);
area.append(tarea);
container.append(page,area);
document.body.append(container);


let nset=document.getElementById('nxt');
nset.addEventListener('click',nxtSet);
let pset=document.getElementById('prev');
pset.addEventListener('click',prevSet);


let bt1 = document.getElementById('id1');
bt1.addEventListener('click',myFun);

let bt2 = document.getElementById('id2');
bt2.addEventListener('click',myFun2);

let bt3 = document.getElementById('id3');
bt3.addEventListener('click',myFun3);

let bt4 = document.getElementById('id4');
bt4.addEventListener('click',myFun4);

let bt5 = document.getElementById('id5');
bt5.addEventListener('click',myFun5);

let bt6 = document.getElementById('id6');
bt6.addEventListener('click',myFun6);
...
function nxtSet(){
    ...
    if(a<100){
        ...
        for(let i=f;i<7;i++){
            ...
            if(a==100){
                document.getElementById('id5').value='end'
                document.getElementById('id6').value='end'
                break;
            }
            s='id';
        }
...
function prevSet(){
    ...
    let b = document.getElementById('id6').value;
    if(a>1){
        let s='id';
        let f=6;
        for(let i=f;i>0;i--){
...
function myFun(){
    ...
    arr.filter((arr)=>{
        if(arr["id"]==v){
            ...
            let n = arr["name"];
            let e = arr["email"];
            document.getElementById('area').value="id:"+i+" "+"name :"+n+" "+"email :"+e;
            console.log(arr);
        }
    })
...
function createArea(ele,class1,id1,row,col){
    let a = document.createElement(ele);
    a.setAttribute('class',class1);
    a.setAttribute('id',id1);
